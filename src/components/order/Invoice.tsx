...
function Invoice({ data, ref }: InvoiceProps) {
  ...
  const paymentsColumns = [
    ...
    },
    {
      ...
      render: (item: any) => (
        <div className="text-sm text-gray-400">{moment(item.payment_date).format('HH:MM:SS A DD-MMM-YYYY')}</div>
      ),
    },
          ...
          <div className="mt-1">
            <table>
              <tr>
                ...
                <td className="text-gray-500">{data?.retailer.first_name} {data?.retailer.last_name}</td>
              </tr>
              <tr>
        ...
        <div>
          ...
          <div className="mt-1">
            <table>
              <tr>
                <td className="font-bold text-gray-500 pr-2">Name </td>
                <td className="text-gray-500">{data?.customer.first_name} {data?.customer.last_name}</td>
              </tr>
              <tr>
                <td className="font-bold text-gray-500 pr-2">Phone </td>
